...
LOCAL_REQUIRED_MODULES := privapp_whitelist_com.android.updater.xml

include $(BUILD_PACKAGE)

include $(CLEAR_VARS)
LOCAL_MODULE := privapp_whitelist_com.android.updater.xml
...
updater_system_libs_path := $(abspath $(LOCAL_PATH))/custom_libs

include $(BUILD_SYSTEM)/base_rules.mk

$(LOCAL_BUILT_MODULE): $(updater_system_deps)
	$(hide) rm -rf $(updater_system_libs_path)/framework.jar
