...
updates_dir=/data/pegasusos_updates

if [ ! -f "$1" ]; then
   echo "Usage: $0 ZIP [UNVERIFIED]"
   echo "Push ZIP to $updates_dir and add it to Updater"
   echo
   echo "The name of ZIP is assumed to have pegasusos-VERSION-DATE-TYPE-* as format"
...
# Assume pegasusos-VERSION-DATE-TYPE-*.zip
...
adb shell "killall com.android.updater 2>/dev/null"
adb shell "sqlite3 /data/data/com.android.updater/databases/updates.db" \
